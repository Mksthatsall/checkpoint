...
import com.mks.projects.checkpointapp.repository.HotelMinPriceRepository;
...
public class InventoryServiceImpl implements InventoryService{
    ...
    public Page<HotelPriceDto> searchHotels(HotelSearchRequest hotelSearchRequest) {
        ...
        Page<HotelPriceDto> hotelPage=  hotelMinPriceRepository.findHotelsWithAvailableInventoy(hotelSearchRequest.getCity(),
